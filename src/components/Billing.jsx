...
const Billing = () => (
  <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className="sm:mt-10 mt-6 flex flex-row flex-wrap gap-4 ">
          <img src={apple} alt="apple" className="w-[128px] h-[28px] cursor-pointer" />
          <img src={google} alt="google" className="w-[90px] h-[30px] cursor-pointer" />
        </div>
      </div>
  </section>
)
